...
export default function LoginPage() {
  ...
  // Check for errors returned from Supabase/Google
  useEffect(() => {
    // 1. Check URL hash (Supabase often sends errors here)
    ...
    // 2. Check URL query (Manual errors from our callback)
  ...
  const handleGoogleLogin = async () => {
    ...
    const { error } = await supabase.auth.signInWithOAuth({
      provider: 'google',
      options: {
        // This tells Google to send the user back to your Callback Route
